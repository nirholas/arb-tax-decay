...
/**
 * @title DeployArbTaxDecay
 * @notice Deploys ArbTaxDecay deterministically to any chain with a Uniswap v4 `PoolManager`.
 *
 ...
 */
contract DeployArbTaxDecay is Script {
    ...
    function run() external {
        ...
        bytes memory creationCode = type(ArbTaxDecayHook).creationCode;
        ...
        console2.log("ArbTaxDecay ", predicted);
        ...
        require(
            keccak256(bytes(IHookMetadata(address(hook)).hookName())) == keccak256(bytes("ArbTaxDecay")),
